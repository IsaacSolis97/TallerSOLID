...
```
Respuesta: Se tiene que seguir el principio de Open Close, por lo que si se debe implementar la clase abstracta para poder extender la clase aderezo, entonces si las subclases cambian su comportamiento, este no modificaría la clase original.
...
```
Respuesta: Se separo el tipo  de leche, a uno mas general, dentro de la clase de manejadordeleche se controlo que no se puede usar leche deslactosada, y asi se tiene clases por cada tipo de leche
